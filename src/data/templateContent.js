...
//     (not generic filler). Use it [situation 1], or [situation 2]. Free, no
//     signup, print it [before X] or [share on phone]."
...
export const templateContent = {
  ...
  'tokyo-travel': {
    ...
    faq: [
      ...
      { q: "Is this good for solo travelers or groups?", a: "Both — solo travelers use it to notice more of the city, groups use it to compare notes over dinner." },
  ...
  'icebreakers': {
    intro: "Get to Know You Bingo is a printable card of 25 things you might not know about the people around you — who speaks more than two languages, who's got a hidden talent, who's run a marathon, who can solve a Rubik's cube. Use it to break the ice on someone's first day at work, in a classroom, or at a team offsite where half the room are strangers. Free, no signup — print it before everyone arrives or share the link on your phone.",
    faq: [
  ...
  'book-reading': {
    intro: "Book Reading Challenge Bingo is a printable card of 25 reading prompts to stretch your TBR pile — a cozy mystery with a punny title, a book with a non-human narrator, a novel with a dual timeline, a debut by a BIPOC author. Use it solo to break out of your usual genres, or run it with a book club and compare who fills a line first. Free, no signup — print it for the new year or track it on your phone as you read.",
    faq: [
      ...
      { q: "Is it free?", a: "Completely free, no signup — and if you want more, check out Acclaimed Books Bingo or 2025 Books Bingo for more reading challenges." }
    ],
  ...
  'food-adventures': {
    intro: "Foodie Adventures Bingo is a printable card of 25 bold food moments — trying durian, eating balut, surviving a spicy dish that made you cry, ordering something off a street cart you couldn't identify. Use it while traveling to check off wild bites as you find them, or hand it to your most adventurous-eater friends and see who racks up the weirder card. Free, no signup — print it before your next trip or pull it up on your phone at the night market.",
    faq: [
  ...
  'enchantments-day': {
    intro: "Enchantments Day Hike Bingo is a printable card of 25 things from the actual Enchantments traverse — the Aasgard Pass crux, turquoise pools at Perfection and Leprechaun Lakes, fearless mountain goats eyeing your salty gear, the 5 am start. Use it solo to mark off the grind before you're too tired to remember it, or pass it to your shuttle car buddies and compare cards after the point-to-point. Free, no signup — print it before permit day or pull it up on your phone at the trailhead.",
    faq: [
  ...
  'hit-songs-2026': {
    ...
    faq: [
      ...
      { q: "Is this for one person or a group?", a: "Works either way — solo listeners mark it off as songs come on shuffle, groups play it as a party game with the radio or a shared playlist." },
  ...
  'happy-news-2026': {
    intro: "Happy News 2026 Bingo is a printable card of 25 real feel-good headlines from this year — 700 vultures released back into the wild, a record-breaking Milwaukee river cleanup, Aspen and Toby's dog reunion, NASA growing stem cells in space. Use it while you catch up on the news, or read through it as a family to balance out the doom-scrolling. Free, no signup — print it before movie night or share it on your phone.",
    faq: [
